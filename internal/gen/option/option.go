...
type Options struct {
	Style               structcopy.DstVarStyle // Style of the destination variable name
	Rule                structcopy.MatchRule   // Matching rule for fields
...
func NewOptions() Options {
	return Options{
		Style:     structcopy.DstVarReturn,
		Rule:      structcopy.MatchRuleName,
		ExactCase: true,
		Getter:    false,
		Stringer:  false,
		Typecast:  false,
