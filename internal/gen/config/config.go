...
type Config struct {
	...
	Log string
	// DryRun instructs structcopy-gen not to write the generated code to the output path.
	DryRun bool
	// Prints instructs structcopy-gen to print the generated code to stdout.
	Prints bool
}
