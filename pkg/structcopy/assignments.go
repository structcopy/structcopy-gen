...
// ConvertField represents an RHS expression.
...
// String returns the string representation of the simple field assignment.
func (s ConvertField) String() string {
	var sb strings.Builder
	sb.WriteString(s.LHS)
	if s.Error {
		sb.WriteString(", err")
...
// RetError returns whether the assignment returns an error value.
func (s ConvertField) RetError() bool {
	return s.Error
}

// MatchMethodField represents an RHS expression.
type MatchMethodField struct {
	LHS         string
	RContainer  string
	MatchMethod string
	Error       bool
...
// String returns the string representation of the simple field assignment.
func (s MatchMethodField) String() string {
	var sb strings.Builder
	sb.WriteString(s.LHS)
	if s.Error {
		sb.WriteString(", err")
	...
	sb.WriteString(" = ")
	sb.WriteString(s.RContainer)
	sb.WriteString(".")
	sb.WriteString(s.MatchMethod)
	sb.WriteString("\n")
	return sb.String()
}

// RetError returns whether the assignment returns an error value.
func (s MatchMethodField) RetError() bool {
	return s.Error
}
...
// SliceStructConvertLoopAssignment represents a slice assignment with a loop and typecast.
type SliceStructConvertLoopAssignment struct {
	LHS           string
	RHS           string
	Typ           string
...
// String returns the string representation of the slice assignment with a loop.
func (c SliceStructConvertLoopAssignment) String() string {
	var sb strings.Builder
	sb.WriteString("if ")
	sb.WriteString("len(")
	sb.WriteString(c.RHS)
...
// RetError returns whether the assignment returns an error value.
func (c SliceStructConvertLoopAssignment) RetError() bool {
	return false
}
